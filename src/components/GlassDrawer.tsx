  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Drawer Tab Content */}
        <div className="tauri-no-drag" style={{ flex: '1 1 0px', minHeight: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden', padding: '4px 2px 2px 2px', borderRadius: '16px' }}>
          {activeTab === 'bookshelf' && (
            <BookshelfView
              books={books}
